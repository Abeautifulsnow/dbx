...
| --- | --- |
| String | Text, JSON, and multiple display formats; gzip/zlib/deflate-compressed values can be viewed decompressed via a Gzip badge or the Decompressed format; binary strings are shown as escaped read-only text |
